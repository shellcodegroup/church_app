...
class HomeOutlineScreen extends StatefulWidget {
  const HomeOutlineScreen({super.key});

  @override
  State<HomeOutlineScreen> createState() => _HomeScreenState();
}
...
class _HomeScreenState extends State<HomeOutlineScreen> {
  @override
